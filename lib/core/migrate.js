...
import { foreignRoots, hiddenZone, skillsRoot } from "./paths.js";
import { listContainerEntries } from "./scan.js";
import { readSkillSummary, validateSkill } from "./validate.js";

// `foreignRoots()` lives in paths.js because the view layer needs it too; re-exported
// here so callers that only care about migration need a single import.
export { foreignRoots };
